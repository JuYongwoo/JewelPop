...
public class MapManager
{
    ...
    private void SetBlocks(JSONVars jsonVars)
    {
        foreach (var grid in jsonVars.grids)
        {
            ...
            board.Add(yx, UnityEngine.Object.Instantiate(AppManager.instance.resourceManager.blockParentObjectPrefab).GetComponent<BlockParent>());
            ...
            GameObject child = UnityEngine.Object.Instantiate(AppManager.instance.resourceManager.blockPrefabs[Enum.Parse<BlockPrefabs>(grid.type)], board[yx].transform);
    ...
    private void AddNewBlocks(List<YX> tops)
    {
        foreach (var pos in tops)
        {
            ...
            GameObject child = UnityEngine.Object.Instantiate(AppManager.instance.resourceManager.blockPrefabs[rd], board[pos].transform);
