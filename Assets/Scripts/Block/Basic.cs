...
public class Basic : BlockChild, CommonBlockInterface
{
    ...
    public void move(Transform targetParent)
    {
        ...
        StartCoroutine(MoveChild(targetParent, aPos, bPos));
    }


    // 자식 Transform을 직접 받아서 이동 (부모에서 다시 GetChild(0) 하지 않음)
    private IEnumerator MoveChild(Transform targetParent, Vector3 startPos, Vector3 endPos)
    {
